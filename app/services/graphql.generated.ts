...
export type AdvertQuery = {
  ...
  advert?: {
    ...
    market?: string | null
    seo?: { __typename?: 'AdvertSeo'; title?: string | null; description?: string | null } | null
    images?: Array<{
      __typename?: 'Image'
    ...
    locationDetails?: {
      ...
      address?: {
        __typename?: 'Address'
        street?: { __typename?: 'Street'; name?: string | null; number?: string | null } | null
        city?: {
          __typename?: 'City'
          id?: string | null
          code?: string | null
...
export type SearchAdsQuery = {
  ...
  searchAds?: {
    __typename?: 'FoundAds'
    items?: Array<{ __typename?: 'AdItem'; id?: string | null } | null> | null
  } | null
}

export const AdvertDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'Advert' },
      variableDefinitions: [
        {
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                {
                  kind: 'InlineFragment',
                  typeCondition: { kind: 'NamedType', name: { kind: 'Name', value: 'Advert' } },
                  selectionSet: {
                    kind: 'SelectionSet',
                    selections: [
                      ...
                      {
                        kind: 'Field',
                        name: { kind: 'Name', value: 'featuresByCategory' },
                        selectionSet: {
                          kind: 'SelectionSet',
                          selections: [
                      ...
                      {
                        kind: 'Field',
                        name: { kind: 'Name', value: 'topInformation' },
                        selectionSet: {
                          kind: 'SelectionSet',
                          selections: [
                            { kind: 'Field', name: { kind: 'Name', value: 'label' } },
                      ...
                      { kind: 'Field', name: { kind: 'Name', value: 'market' } },
                      {
                        ...
                        selectionSet: {
                          ...
                          selections: [
                            ...
                            { kind: 'Field', name: { kind: 'Name', value: 'value' } },
                            { kind: 'Field', name: { kind: 'Name', value: 'label' } },
                            { kind: 'Field', name: { kind: 'Name', value: 'localizedValue' } },
...
export const SearchAdsDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'SearchAds' },
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
          {
                ...
                value: {
                  ...
                  fields: [
                    ...
                    },
                    {
                      ...
                      value: { kind: 'EnumValue', value: 'LATEST' },
                    },
                  ],
                },
              },
            ...
            selectionSet: {
              ...
              selections: [
                {
                  kind: 'InlineFragment',
                  typeCondition: { kind: 'NamedType', name: { kind: 'Name', value: 'FoundAds' } },
                  selectionSet: {
                    kind: 'SelectionSet',
                    selections: [
                      {
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    Advert(
      variables: AdvertQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders
    ): Promise<AdvertQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<AdvertQuery>(AdvertDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'Advert',
    ...
    SearchAds(
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<SearchAdsQuery>(SearchAdsDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        'SearchAds',
