...
export type SocialNetworkAccountType = z.infer<typeof SocialNetworkAccountTypeSchema>
...
const ParkingParam = z.object({
  key: z.literal('parking'),
  name: z.string(),
...
const PricePerM = z.object({
  key: z.literal('price_per_m'),
  name: z.string(),
  type: z.literal('input'),
  value: z.object({
    value: z.union([z.number(), z.null()]).optional(),
...
export const OlxOfferSchema = z.object({
  id: z.number(),
  url: z.string(),
  title: z.string(),
...
export type Datum = z.infer<typeof OlxOfferSchema>
